...
map.getView().fit([16142528.363007, -4558663.635531, 16143150.588107, -4558374.870502], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">LN-SLC-Map</h2>';
        return titleElement;
    })(),
...
map.once('rendercomplete', function() {
  ...
  if (bottomAttributionUl) {
    ...
    var attribHtml = `
    <a href="https://www.superloop.com/">SuperLoop</a> &middot;
    <a href="https://www.neoloop.com.au/">Lynham Networks</a> &middot;
